				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-8 col-md-offset-3">
							<form  action="/admin/admin/loginPost"  method="post" onsubmit="return loginCheck();">
								...
								<div class="row">
									<div class="col-md-8">
										<div class="form-group">
										<button class="btn btn-black" type="submit"> 로그인 </button>
										&nbsp; &nbsp; &nbsp;
										<a href="/admin/admin/join" class="btn btn-white"> 가입  </a>
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 col-xs-6 footer-widget">
						...
						<ul class="row footer-links">
							...
							<li>본 연구는 설문 조사를 통해 업종 별 직무 특성과 개인의 경력 지향의 차이가 업무 만족도와 이직 의도와의 관계를
							이해하고자 합니다.<br> </li>
							
							<li>본 설문은 순수한 연구목적에만 사용되며, 본 연구를 통해 알게 된 개인의 정보와
							설문 결과는 개인 동의 없이 외부로의 유출이나 공개되지 않습니다.<br> </li>
							
							<li>직무 특성과 경력 지향 대한 설문
							결과를 확인해주세요.</li>
					...
					<div class="col-md-6 col-sm-6 col-xs-6 footer-widget">
						...
						<p> 문의 사항은(Email,메일주소)로 연락해 주시면 성심 성의껏 답변해 드리도록
							하겠습니다.</p>

						<div class="footer-address">
							<p>
								(34430) 대전광역시 대덕구 한남로 70 한남대학교 대학원 경영정보학과 <br>
								Email : clicku123@gmail.com
							</p>
						</div>
