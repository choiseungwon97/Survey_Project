		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-3">
					<form role="form" method="post" class="notify">
						<div class="headline">
								...
								<div class="col-md-6">
									<div class="form-group">
										<input name="id" type="text" class="form-control" id="id"
											required="required" value="${adminVO.id}" readonly>
									</div>
								</div>
							</div>
								...
								<div class="col-md-6">
									<div class="form-group">
										<input name="companyName" type="text" class="form-control" id="companyName"
											required="required" value="${adminVO.companyName}" >
									</div>
								</div>
							</div>
								...
								<div class="col-md-6">
									<div class="form-group">
										<input name="postCode" type="text" class="form-control" id="postCode"
												required="required" value="${adminVO.postCode}">
								...
								<div class="col-md-6">
									<div class="form-group">
										<input name="address" type="text" class="form-control" id="address"
												required="required" value="${adminVO.address}">
									</div>
								</div>
							</div>
								...
								<div class="col-md-6">
									<div class="form-group">
										<input name="tel" type="text" class="form-control" id="tel"
												required="required" value="${adminVO.tel}">
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										<input name="employeeName" type="text" class="form-control" id="employeeName"
												required="required" value="${adminVO.employeeName}">
						...
						<div class="row">
							<div class="col-md-8">
								<div class="headline text-right">
									...
									<a href="/admin/admin/company/read?id=${adminVO.id}" class="btn btn-white">BACK</a>
								</div>
							</div>
						</div>
					</form>
